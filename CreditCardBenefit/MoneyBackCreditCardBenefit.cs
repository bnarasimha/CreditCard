namespace HDFCCreditCard
{
    class MoneyBackCreditCardBenefit : ICreditCardBenefit
    {
        ...
        public MoneyBackCreditCardBenefit(){
            ...
            creditCard = new MoneyBackCreditCard();        
        }
        ...
        public void printBenefit(){
            Console.WriteLine("Hi, " + _creditCardTransaction.customer.Name + ". You have spent " + _creditCardTransaction.transactionAmount + " on " + creditCard.Name + " Credit Card. So the cashback for the transaction is: " + _cashBackAmount);
        }
    }
}