namespace HDFCCreditCard
{
    class RegaliaCreditCardBenefit : ICreditCardBenefit
    {
        ...
        public void printBenefit(){
            Console.WriteLine("Hi, " + _creditCardTransaction.customer.Name + ". You have spent " + _creditCardTransaction.transactionAmount + " on " + _creditCard.Name + " Credit Card. So your total reward points for this transaction is: " + _rewardPoints);
        }
    }
}