namespace HDFCCreditCard
{
    class RegaliaCreditCardHolidayPassBenefit : ICreditCardBenefit
    {
        ...
        public RegaliaCreditCardHolidayPassBenefit(){
            ...
            _creditCard = new RegaliaCreditCard(); 
        }
        ...
        public void printBenefit(){
            if(_creditCardTransaction.transactionAmount >= 100000){
                Console.WriteLine("Hi, " + _creditCardTransaction.customer.Name + ". You have spent " + _creditCardTransaction.transactionAmount + " on " + _creditCard.Name + " Credit Card in the entire year. So as a reward here is your Holiday Pass: " + _holidayPass + ". Please enjoy.");
            }
            else{
                Console.WriteLine("Hi, " + _creditCardTransaction.customer.Name + ". Thank you for using " + _creditCard.Name + " Credit Card.");
            }
        }
    }
}